  ...
  const teamMembers = {
    heads: [
      ...
      },
      {
        ...
        role: "Head of Heron",
        department: "Electrical & Computer Engineering",
        expertise: "Electrical Installations, Automation Systems, PLC Programming",
    ...
    hermes: [
      {
        ...
        role: "Team Director of Project Hermes",
        year: "Undergraduate",
        expertise: "Mechanical Engineering, Aerodynamics, Fluid Dynamics, Project Management",
        email: "fillipos.stamos@student.edu",
        image: "/boy.png",
        social: {}
      },
      {
    ...
    zephyr: [
      {
        ...
        year: "Undergraduate",
        expertise: "FPGA Programming, Integrated Circuit Design, Computer Architecture, Embedded Systems",
    ...
    heron: [
      ...
      {
        name: "Ioannis Vlachavas",
        role: "Electrical & Computer Engineering Student",
        year: "Undergraduate",
        expertise: "PLC Programming, Automation Systems",
        email: "ioannis.vlachavas@student.edu",
        image: "/boy.png",
        social: {}
      },
      {
                         ...
                         <div className="mt-auto">
                           ...
                           <div className="flex items-center justify-center sm:justify-start gap-2 sm:gap-3">
                             ...
                             {'instagram' in member.social && member.social.instagram && (
                               <svg className="h-3 w-3 sm:h-4 sm:w-4 text-gray-500 dark:text-gray-400 cursor-pointer" 
                                 fill="currentColor" 
                                 viewBox="0 0 24 24"
                                 onClick={() => member.social && 'instagram' in member.social ? window.open(member.social.instagram, '_blank', 'noopener,noreferrer') : null}
                               >
                             ...
                             {'youtube' in member.social && member.social.youtube && (
                               <svg className="h-3 w-3 sm:h-4 sm:w-4 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 24 24">
